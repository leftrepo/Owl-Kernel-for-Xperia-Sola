cmd_scripts/kallsyms := gcc -Wp,-MD,scripts/.kallsyms.d -O3 -fmodulo-sched -fmodulo-sched-allow-regmoves -Wall -Wmissing-prototypes -Wstrict-prototypes -fomit-frame-pointer -fno-inline-functions     -o scripts/kallsyms scripts/kallsyms.c  
