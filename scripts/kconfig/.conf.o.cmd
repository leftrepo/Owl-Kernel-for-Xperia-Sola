cmd_scripts/kconfig/conf.o := gcc -Wp,-MD,scripts/kconfig/.conf.o.d -O3 -fmodulo-sched -fmodulo-sched-allow-regmoves -Wall -Wmissing-prototypes -Wstrict-prototypes -fomit-frame-pointer -fno-inline-functions   -DCURSES_LOC="<ncurses.h>" -DLOCALE   -c -o scripts/kconfig/conf.o scripts/kconfig/conf.c
