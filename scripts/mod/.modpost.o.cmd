cmd_scripts/mod/modpost.o := gcc -Wp,-MD,scripts/mod/.modpost.o.d -O3 -fmodulo-sched -fmodulo-sched-allow-regmoves -Wall -Wmissing-prototypes -Wstrict-prototypes -fomit-frame-pointer -fno-inline-functions     -c -o scripts/mod/modpost.o scripts/mod/modpost.c
