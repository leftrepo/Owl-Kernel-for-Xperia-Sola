...
struct led_limits {
	...
	unsigned long flash_duration_step;
};

/*
 * Min/Max/step torch/flash values and also Min/Max/Step duration values.
				    ...
				    unsigned long *flash_duration)
{
	...
	*flash_duration = ((reg_duration & LM3561_FLASH_DURATION_MASK)
		* lm3561_limits.flash_duration_step
