...
@@ -1546,7 +1547,7 @@ config HAVE_ARCH_PFN_VALID
...
index 511eb03..5b8b222 100644
--- a/arch/arm/kernel/smp.c
+++ b/arch/arm/kernel/smp.c
@@ -311,6 +311,18 @@ asmlinkage void __cpuinit secondary_start_kernel(void)
...
@@ -324,15 +336,6 @@ asmlinkage void __cpuinit secondary_start_kernel(void)
...
-	/*
 	 ...
 	 */
 	cpu_idle();
@@ -537,7 +540,7 @@ static void percpu_timer_stop(void)
 }
 #endif
...
@@ -546,10 +549,10 @@ static void ipi_cpu_stop(unsigned int cpu)
 {
...
@@ -256,8 +257,6 @@ DEFINE_PER_CPU(int, cpu_state);
...
@@ -265,8 +264,6 @@ static int octeon_cpu_disable(void)
 	if (cpu == 0)
 		return -EBUSY;
...
-
 	...
 	local_irq_disable();
@@ -276,8 +273,6 @@ static int octeon_cpu_disable(void)
 	flush_cache_all();
 	local_flush_tlb_all();
...
index 6786f9d..3b1d3e6 100644
--- a/arch/powerpc/platforms/cell/spufs/inode.c
+++ b/arch/powerpc/platforms/cell/spufs/inode.c
@@ -166,18 +166,18 @@ static void spufs_prune_dir(struct dentry *dir)
...
index abdc2b1..3d7eb55 100644
--- a/arch/s390/kernel/process.c
+++ b/arch/s390/kernel/process.c
@@ -93,9 +93,7 @@ void cpu_idle(void)
 		while (!need_resched())
 			default_idle();
 		tick_nohz_restart_sched_tick();
-		preempt_enable_no_resched();
...
@@ -409,7 +410,8 @@ void __kprobes do_asce_exception(struct pt_regs *regs, long pgm_int_code,
...
@@ -39,6 +40,7 @@ asmlinkage void alignment_check(void);
...
@@ -65,6 +67,7 @@ dotraplinkage void do_alignment_check(struct pt_regs *, long);
...
@@ -1794,8 +1794,8 @@ void smp_spurious_interrupt(struct pt_regs *regs)
 {
 	u32 v;
...
@@ -1831,8 +1831,8 @@ void smp_error_interrupt(struct pt_regs *regs)
...
index 1579ab9..ec156ff 100644
--- a/arch/x86/kernel/cpu/common.c
+++ b/arch/x86/kernel/cpu/common.c
@@ -1047,7 +1047,9 @@ DEFINE_PER_CPU(unsigned int, irq_count) = -1;
  */
...
@@ -332,33 +322,16 @@ static void __cpuinit amd_calc_l3_indices(struct amd_l3_cache *l3)
...
+		amd_calc_l3_indices(this_leaf->nb);
 ...
 /*
@@ -368,11 +341,11 @@ static void __cpuinit amd_init_l3_cache(struct _cpuid4_info_regs *this_leaf, int
  *
...
+	pci_read_config_dword(nb->misc, 0x1BC + slot * 4, &reg);
 	...
 	if (reg & (3UL << 30))
@@ -386,11 +359,10 @@ static ssize_t show_cache_disable(struct _cpuid4_info *this_leaf, char *buf,
 {
 	int index;
...
@@ -407,7 +379,7 @@ show_cache_disable_##slot(struct _cpuid4_info *this_leaf, char *buf,	\
...
+static void amd_l3_disable_index(struct amd_northbridge *nb, int cpu,
 ...
 {
 	int i;
@@ -420,10 +392,10 @@ static void amd_l3_disable_index(struct amd_l3_cache *l3, int cpu,
 	for (i = 0; i < 4; i++) {
 		u32 reg = idx | (i << 20);
...
@@ -433,7 +405,7 @@ static void amd_l3_disable_index(struct amd_l3_cache *l3, int cpu,
 		wbinvd_on_cpu(cpu);
...
@@ -447,24 +419,24 @@ static void amd_l3_disable_index(struct amd_l3_cache *l3, int cpu,
  *
...
@@ -479,8 +451,7 @@ static ssize_t store_cache_disable(struct _cpuid4_info *this_leaf,
...
@@ -488,7 +459,7 @@ static ssize_t store_cache_disable(struct _cpuid4_info *this_leaf,
...
@@ -517,7 +488,7 @@ static struct _cache_attr cache_disable_1 = __ATTR(cache_disable_1, 0644,
 static ssize_t
...
@@ -532,7 +503,7 @@ store_subcaches(struct _cpuid4_info *this_leaf, const char *buf, size_t count,
 	if (!capable(CAP_SYS_ADMIN))
 		return -EPERM;
...
@@ -797,7 +768,7 @@ static void __cpuinit cache_shared_cpu_map_setup(unsigned int cpu, int index)
 	}
...
@@ -848,29 +819,19 @@ static void __cpuinit free_cache_attributes(unsigned int cpu)
...
@@ -928,16 +889,16 @@ static ssize_t show_##file_name(struct _cpuid4_info *this_leaf, char *buf, \
...
@@ -974,7 +935,7 @@ static inline ssize_t show_shared_cpu_list(struct _cpuid4_info *leaf, char *buf,
...
@@ -1163,7 +1124,7 @@ static int __cpuinit cache_add_dev(struct sys_device * sys_dev)
...
-		}
 		...
 		break;
 	case CPU_POST_DEAD:
@@ -2139,6 +2178,8 @@ static __init int mcheck_init_device(void)
...
index 99cd9d2..98a11a2 100644
--- a/arch/x86/kernel/cpu/mcheck/therm_throt.c
+++ b/arch/x86/kernel/cpu/mcheck/therm_throt.c
@@ -381,8 +381,8 @@ static void (*smp_thermal_vector)(void) = unexpected_thermal_interrupt;
...
index 2df1252..be2949e 100644
--- a/arch/x86/kernel/entry_32.S
+++ b/arch/x86/kernel/entry_32.S
@@ -628,7 +628,11 @@ work_notifysig:				# deal with pending signals and
...
+	TRACE_IRQS_OFF
 	...
 	ALIGN
@@ -641,7 +645,11 @@ work_notifysig_v86:
 	movl %esp, %eax
 #endif
 	xorl %edx, %edx
+	TRACE_IRQS_ON
...
+
 	...
 	/* edi:  new selector */
@@ -1197,6 +1199,7 @@ ENTRY(kernel_execve)
 	CFI_ENDPROC
 END(kernel_execve)
...
+#ifndef CONFIG_PREEMPT_RT_FULL
 ...
 ENTRY(call_softirq)
 	CFI_STARTPROC
@@ -1216,6 +1219,7 @@ ENTRY(call_softirq)
 	ret
 	CFI_ENDPROC
 END(call_softirq)
+#endif
...
index a669961..ae63ab5 100644
--- a/arch/x86/kernel/irq.c
+++ b/arch/x86/kernel/irq.c
@@ -176,8 +176,8 @@ unsigned int __irq_entry do_IRQ(struct pt_regs *regs)
...
@@ -204,10 +204,10 @@ void smp_x86_platform_ipi(struct pt_regs *regs)
...
@@ -337,6 +336,41 @@ __switch_to(struct task_struct *prev_p, struct task_struct *next_p)
...
@@ -881,6 +895,12 @@ void __init trap_init(void)
...
index 34afae8..60d6a91 100644
--- a/arch/x86/kvm/x86.c
+++ b/arch/x86/kvm/x86.c
@@ -2276,6 +2276,13 @@ static void do_cpuid_1_ent(struct kvm_cpuid_entry2 *entry, u32 function,
 	entry->flags = 0;
 }
...
@@ -2386,6 +2393,8 @@ static void do_cpuid_ent(struct kvm_cpuid_entry2 *entry, u32 function,
 		}
 		break;
 	}
+	case 9:
...
@@ -2403,16 +2412,17 @@ static void do_cpuid_ent(struct kvm_cpuid_entry2 *entry, u32 function,
 		break;
 	}
 	case 0xd: {
-		int i;
...
@@ -2444,6 +2454,24 @@ static void do_cpuid_ent(struct kvm_cpuid_entry2 *entry, u32 function,
...
@@ -2453,10 +2481,16 @@ static void do_cpuid_ent(struct kvm_cpuid_entry2 *entry, u32 function,
...
@@ -4919,6 +4953,13 @@ int kvm_arch_init(void *opaque)
 		goto out;
 	}
...
index 7653f14..8e30e54 100644
--- a/arch/x86/mm/fault.c
+++ b/arch/x86/mm/fault.c
@@ -1070,7 +1070,7 @@ do_page_fault(struct pt_regs *regs, unsigned long error_code)
 	 * If we're in an interrupt, have no user context or are running
 	 * in an atomic region then we must not take the fault:
 	 */
-	if (unlikely(in_atomic() || !mm)) {
...
index af66776..b9660cc 100644
--- a/drivers/acpi/ec.c
+++ b/drivers/acpi/ec.c
@@ -228,7 +228,7 @@ static int ec_poll(struct acpi_ec *ec)
...
+				if (swait_event_timeout(ec->wait,
 						...
 						msecs_to_jiffies(1)))
 					return 0;
@@ -276,7 +276,7 @@ static int ec_wait_ibf0(struct acpi_ec *ec)
...
+		if (swait_event_timeout(ec->wait, ec_check_ibf0(ec),
 			...
 			return 0;
 	return -ETIME;
@@ -616,7 +616,7 @@ static u32 acpi_ec_gpe_handler(acpi_handle gpe_device,
...
@@ -680,7 +680,7 @@ static struct acpi_ec *make_acpi_ec(void)
 		return NULL;
...
+	raw_spin_lock_irqsave(&dca_lock, flags);
 	...
 	if (list_empty(&dca_domains)) {
 		spin_unlock_irqrestore(&dca_lock, flags);
@@ -421,7 +431,7 @@ void unregister_dca_provider(struct dca_provider *dca, struct device *dev)
...
index 9f472d5..5221349 100644
--- a/drivers/md/dm.c
+++ b/drivers/md/dm.c
@@ -1672,14 +1672,14 @@ static void dm_request_fn(struct request_queue *q)
...
index cff955a..02e786e 100644
--- a/drivers/md/raid5.c
+++ b/drivers/md/raid5.c
@@ -1228,8 +1228,9 @@ static void __raid_run_ops(struct stripe_head *sh, unsigned long ops_request)
...
+	spin_lock(&percpu->lock);
 	if (test_bit(STRIPE_OP_BIOFILL, &ops_request)) {
 		ops_run_biofill(sh);
 		overlap_clear++;
@@ -1281,7 +1282,8 @@ static void __raid_run_ops(struct stripe_head *sh, unsigned long ops_request)
...
@@ -4768,6 +4770,7 @@ static int raid5_alloc_percpu(raid5_conf_t *conf)
 			break;
 		}
...
index 0c3f234..0ee5518 100644
--- a/drivers/net/Kconfig
+++ b/drivers/net/Kconfig
@@ -3411,6 +3411,7 @@ config NET_FC
...
index 5e34e21..1519ba7 100644
--- a/drivers/net/atl1c/atl1c_main.c
+++ b/drivers/net/atl1c/atl1c_main.c
@@ -2218,11 +2218,7 @@ static netdev_tx_t atl1c_xmit_frame(struct sk_buff *skb,
 	}
...
index 68baf17..7e3378d 100644
--- a/drivers/pci/intel-iommu.c
+++ b/drivers/pci/intel-iommu.c
@@ -935,7 +935,7 @@ static void iommu_set_root_entry(struct intel_iommu *iommu)
...
@@ -944,7 +944,7 @@ static void iommu_set_root_entry(struct intel_iommu *iommu)
...
@@ -955,14 +955,14 @@ static void iommu_flush_write_buffer(struct intel_iommu *iommu)
...
@@ -989,14 +989,14 @@ static void __iommu_flush_context(struct intel_iommu *iommu,
 	}
 	val |= DMA_CCMD_ICC;
...
+	raw_spin_unlock_irqrestore(&iommu->register_lock, flag);
 ...
 /* return value determine if we need a write buffer flush */
@@ -1035,7 +1035,7 @@ static void __iommu_flush_iotlb(struct intel_iommu *iommu, u16 did,
...
@@ -1045,7 +1045,7 @@ static void __iommu_flush_iotlb(struct intel_iommu *iommu, u16 did,
...
@@ -1161,7 +1161,7 @@ static void iommu_disable_protect_mem_regions(struct intel_iommu *iommu)
 	u32 pmen;
 	unsigned long flags;
...
@@ -1170,7 +1170,7 @@ static void iommu_disable_protect_mem_regions(struct intel_iommu *iommu)
...
@@ -1178,7 +1178,7 @@ static int iommu_enable_translation(struct intel_iommu *iommu)
 	u32 sts;
 	unsigned long flags;
...
@@ -1186,7 +1186,7 @@ static int iommu_enable_translation(struct intel_iommu *iommu)
 	IOMMU_WAIT_OP(iommu, DMAR_GSTS_REG,
...
@@ -1195,7 +1195,7 @@ static int iommu_disable_translation(struct intel_iommu *iommu)
 	u32 sts;
 	unsigned long flag;
...
@@ -1203,7 +1203,7 @@ static int iommu_disable_translation(struct intel_iommu *iommu)
 	IOMMU_WAIT_OP(iommu, DMAR_GSTS_REG,
 		      readl, (!(sts & DMA_GSTS_TES)), sts);
...
@@ -3361,7 +3361,7 @@ static int iommu_suspend(void)
...
+		raw_spin_lock_irqsave(&iommu->register_lock, flag);
 		...
 		iommu->iommu_state[SR_DMAR_FECTL_REG] =
 			readl(iommu->reg + DMAR_FECTL_REG);
@@ -3372,7 +3372,7 @@ static int iommu_suspend(void)
...
@@ -3399,7 +3399,7 @@ static void iommu_resume(void)
...
@@ -3410,7 +3410,7 @@ static void iommu_resume(void)
...
index 9d5af9b..6a2216e 100644
--- a/drivers/usb/core/hcd.c
+++ b/drivers/usb/core/hcd.c
@@ -2117,7 +2117,7 @@ irqreturn_t usb_hcd_irq (int irq, void *__hcd)
...
+	local_irq_save_nort(flags);
 	...
 	if (unlikely(HCD_DEAD(hcd) || !HCD_HW_ACCESSIBLE(hcd))) {
 		rc = IRQ_NONE;
@@ -2130,7 +2130,7 @@ irqreturn_t usb_hcd_irq (int irq, void *__hcd)
 		rc = IRQ_HANDLED;
 	}
...
index 2c69d12..309879d 100644
--- a/fs/autofs4/expire.c
+++ b/fs/autofs4/expire.c
@@ -90,7 +90,7 @@ static struct dentry *get_next_positive_subdir(struct dentry *prev,
...
+		seq_spin_lock(&root->d_lock);
 		...
 		p = prev;
@@ -98,12 +98,12 @@ static struct dentry *get_next_positive_subdir(struct dentry *prev,
 	}
...
@@ -547,7 +547,7 @@ int autofs4_do_expire_multi(struct super_block *sb, struct vfsmount *mnt,
...
@@ -555,7 +555,7 @@ int autofs4_do_expire_multi(struct super_block *sb, struct vfsmount *mnt,
...
@@ -599,9 +599,9 @@ static int autofs4_dir_unlink(struct inode *dir, struct dentry *dentry)
...
+	seq_spin_unlock(&dentry->d_lock);
 	...
 	return 0;
@@ -672,15 +672,15 @@ static int autofs4_dir_rmdir(struct inode *dir, struct dentry *dentry)
 		return -EACCES;
...
+	seq_spin_unlock(&this_parent->d_lock);
 	if (!locked && read_seqretry(&rename_lock, seq))
 		goto rename_retry;
 	if (locked)
@@ -1134,7 +1135,7 @@ static int select_parent(struct dentry * parent)
...
+	seq_spin_unlock(&this_parent->d_lock);
 	if (!locked && read_seqretry(&rename_lock, seq))
 		goto rename_retry;
 	if (locked)
@@ -1298,8 +1299,7 @@ struct dentry *d_alloc(struct dentry * parent, const struct qstr *name)
...
+	seqlock_init(&dentry->d_lock);
 	...
 	dentry->d_sb = NULL;
@@ -1312,7 +1312,7 @@ struct dentry *d_alloc(struct dentry * parent, const struct qstr *name)
...
+		seq_spin_lock(&parent->d_lock);
 		 ...
 		 * to concurrency here
@@ -1322,7 +1322,7 @@ struct dentry *d_alloc(struct dentry * parent, const struct qstr *name)
...
@@ -1379,7 +1379,7 @@ EXPORT_SYMBOL(d_set_d_op);
...
+	seq_spin_lock(&dentry->d_lock);
 	if (inode) {
 		if (unlikely(IS_AUTOMOUNT(inode)))
 			dentry->d_flags |= DCACHE_NEED_AUTOMOUNT;
@@ -1387,7 +1387,7 @@ static void __d_instantiate(struct dentry *dentry, struct inode *inode)
 	}
...
@@ -1593,7 +1593,7 @@ struct dentry *d_obtain_alias(struct inode *inode)
 	}
...
+	seq_spin_lock(&tmp->d_lock);
 	...
 	tmp->d_inode = inode;
@@ -1602,7 +1602,7 @@ struct dentry *d_obtain_alias(struct inode *inode)
...
@@ -1814,7 +1814,7 @@ struct dentry *__d_lookup_rcu(struct dentry *parent, struct qstr *name,
 			continue;
...
@@ -1932,7 +1932,7 @@ struct dentry *__d_lookup(struct dentry *parent, struct qstr *name)
...
+		seq_spin_lock(&dentry->d_lock);
 		if (dentry->d_parent != parent)
 			goto next;
 		if (d_unhashed(dentry))
@@ -1956,10 +1956,10 @@ struct dentry *__d_lookup(struct dentry *parent, struct qstr *name)
...
@@ -2007,17 +2007,17 @@ int d_validate(struct dentry *dentry, struct dentry *dparent)
 {
 	struct dentry *child;
...
@@ -2052,13 +2052,13 @@ void d_delete(struct dentry * dentry)
...
@@ -2099,9 +2099,9 @@ static void _d_rehash(struct dentry * entry)
...
@@ -2124,11 +2124,9 @@ void dentry_update_name_case(struct dentry *dentry, struct qstr *name)
...
@@ -2179,24 +2177,24 @@ static void dentry_lock_for_move(struct dentry *dentry, struct dentry *target)
...
@@ -2204,9 +2202,9 @@ static void dentry_unlock_parents_for_move(struct dentry *dentry,
...
+		seq_spin_unlock(&target->d_parent->d_lock);
 ...
 /*
@@ -2239,8 +2237,8 @@ static void __d_move(struct dentry * dentry, struct dentry * target)
...
@@ -2275,13 +2273,13 @@ static void __d_move(struct dentry * dentry, struct dentry * target)
...
+	seq_spin_unlock(&dentry->d_lock);
 ...
 /*
@@ -2369,8 +2367,8 @@ static void __d_materialise_dentry(struct dentry *dentry, struct dentry *anon)
...
@@ -2392,11 +2390,11 @@ static void __d_materialise_dentry(struct dentry *dentry, struct dentry *anon)
 	else
...
@@ -2464,10 +2462,10 @@ struct dentry *d_materialise_unique(struct dentry *dentry, struct inode *inode)
 	else
...
+	seq_spin_unlock(&actual->d_lock);
 ...
 out_nolock:
 	if (actual == dentry) {
@@ -2528,9 +2526,9 @@ static int prepend_path(const struct path *path,
 		}
 		parent = dentry->d_parent;
 		prefetch(parent);
-		spin_lock(&dentry->d_lock);
...
+		seq_spin_unlock(&dentry->d_lock);
 		...
 		if (error)
@@ -2755,9 +2753,9 @@ static char *__dentry_path(struct dentry *dentry, char *buf, int buflen)
 		int error;
...
@@ -2947,7 +2945,7 @@ void d_genocide(struct dentry *root)
 	seq = read_seqbegin(&rename_lock);
 again:
 	this_parent = root;
-	spin_lock(&this_parent->d_lock);
...
+	seq_spin_lock(&p->fs->lock);
 	...
 	for (t = next_thread(p); t != p; t = next_thread(t)) {
 		if (t->fs == p->fs)
@@ -1262,7 +1264,7 @@ int check_unsafe_exec(struct linux_binprm *bprm)
 			res = 1;
 		}
 	}
...
index 5de8a27..72a2472 100644
--- a/fs/ext4/inode.c
+++ b/fs/ext4/inode.c
@@ -5903,7 +5903,7 @@ int ext4_page_mkwrite(struct vm_area_struct *vma, struct vm_fault *vmf)
...
+	anon_down_read(&inode->i_alloc_sem);
 	...
 	if (page->mapping != mapping || size <= page_offset(page)
 	    || !PageUptodate(page)) {
@@ -5915,7 +5915,7 @@ int ext4_page_mkwrite(struct vm_area_struct *vma, struct vm_fault *vmf)
 	lock_page(page);
...
@@ -5933,7 +5933,7 @@ int ext4_page_mkwrite(struct vm_area_struct *vma, struct vm_fault *vmf)
...
@@ -5962,11 +5962,11 @@ int ext4_page_mkwrite(struct vm_area_struct *vma, struct vm_fault *vmf)
 	 */
 	lock_page(page);
 	wait_on_page_writeback(page);
-	up_read(&inode->i_alloc_sem);
...
index 69a1e0f..a267fb0 100644
--- a/fs/fuse/inode.c
+++ b/fs/fuse/inode.c
@@ -667,11 +667,11 @@ static int fuse_encode_fh(struct dentry *dentry, u32 *fh, int *max_len,
 	if (encode_parent) {
 		struct inode *parent;
...
index fd88add..915e857 100644
--- a/fs/isofs/export.c
+++ b/fs/isofs/export.c
@@ -140,13 +140,13 @@ isofs_export_encode_fh(struct dentry *dentry,
 	if (connectable && !S_ISDIR(inode->i_mode)) {
 		struct inode *parent;
...
index 4033264..9d0bad3 100644
--- a/fs/nfs/dir.c
+++ b/fs/nfs/dir.c
@@ -1814,9 +1814,9 @@ static int nfs_unlink(struct inode *dir, struct dentry *dentry)
...
@@ -1826,7 +1826,7 @@ static int nfs_unlink(struct inode *dir, struct dentry *dentry)
 		__d_drop(dentry);
 		need_rehash = 1;
 	}
-	spin_unlock(&dentry->d_lock);
...
index ebe8db4..9db660e 100644
--- a/fs/reiserfs/inode.c
+++ b/fs/reiserfs/inode.c
@@ -1613,7 +1613,7 @@ int reiserfs_encode_fh(struct dentry *dentry, __u32 * data, int *lenp,
...
@@ -1622,7 +1622,7 @@ int reiserfs_encode_fh(struct dentry *dentry, __u32 * data, int *lenp,
...
index d8c1bb5..9721d2d 100644
--- a/fs/udf/namei.c
+++ b/fs/udf/namei.c
@@ -1301,13 +1301,13 @@ static int udf_encode_fh(struct dentry *de, __u32 *fh, int *lenp,
...
index 42af2ea..7039ac7 100644
--- a/include/linux/cpu.h
+++ b/include/linux/cpu.h
@@ -135,6 +135,8 @@ extern struct sysdev_class cpu_sysdev_class;
...
@@ -157,6 +159,8 @@ static inline void cpu_hotplug_driver_unlock(void)
...
@@ -326,8 +325,8 @@ static inline int __d_rcu_to_refcount(struct dentry *dentry, unsigned seq)
 {
 	int ret = 0;
...
@@ -370,9 +369,9 @@ static inline struct dentry *dget_dlock(struct dentry *dentry)
...
@@ -403,9 +402,9 @@ static inline int cant_mount(struct dentry *dentry)
...
index 212ea7b..aceb8af 100644
--- a/include/linux/fs.h
+++ b/include/linux/fs.h
@@ -781,7 +781,7 @@ struct inode {
...
+	preempt_enable_rt();
 	...
 	preempt_disable();
 	inode->i_size = i_size;
@@ -2506,9 +2508,9 @@ static inline ino_t parent_ino(struct dentry *dentry)
...
index 921336f..1745dc2 100644
--- a/include/linux/init_task.h
+++ b/include/linux/init_task.h
@@ -49,7 +49,7 @@ extern struct fs_struct init_fs;
 	.cputimer	= { 						\
...
@@ -142,6 +142,14 @@ extern struct task_group root_task_group;
...
@@ -179,7 +187,7 @@ extern struct task_group root_task_group;
 	.group_leader	= &tsk,						\
...
+	.comm		= INIT_TASK_COMM,				\
 	...
 	.fs		= &init_fs,					\
 	.files		= &init_files,					\
@@ -196,6 +204,7 @@ extern struct task_group root_task_group;
...
@@ -205,7 +207,7 @@ extern void devm_free_irq(struct device *dev, unsigned int irq, void *dev_id);
...
@@ -380,9 +383,13 @@ static inline int disable_irq_wake(unsigned int irq)
...
@@ -436,8 +443,14 @@ struct softirq_action
...
@@ -449,6 +462,8 @@ static inline void __raise_softirq_irqoff(unsigned int nr)
...
@@ -489,8 +504,9 @@ extern void __send_remote_softirq(struct call_single_data *cp, int cpu,
...
@@ -515,27 +531,36 @@ struct tasklet_struct name = { NULL, 0, ATOMIC_INIT(1), func, data }
 enum
 {
...
+#define tasklet_tryunlock(t)	1
 ...
 #endif
@@ -584,17 +609,8 @@ static inline void tasklet_disable(struct tasklet_struct *t)
 	smp_mb();
 }
...
@@ -626,6 +642,12 @@ void tasklet_hrtimer_cancel(struct tasklet_hrtimer *ttimer)
...
index 3a3925d..5af4091 100644
--- a/include/linux/kernel.h
+++ b/include/linux/kernel.h
@@ -359,7 +359,7 @@ extern enum system_states {
 	SYSTEM_HALT,
 	SYSTEM_POWER_OFF,
 	SYSTEM_RESTART,
-	SYSTEM_SUSPEND_DISK,
...
index 02f887a..1346ea3 100644
--- a/include/linux/netdevice.h
+++ b/include/linux/netdevice.h
@@ -1757,6 +1757,7 @@ struct softnet_data {
 	unsigned		dropped;
...
@@ -110,11 +110,11 @@ struct prop_local_single {
 	 */
 	unsigned long period;
 	int shift;
-	spinlock_t lock;		/* protect the snapshot state */
...
@@ -1258,14 +1263,17 @@ struct task_struct {
 #endif
...
@@ -1359,6 +1367,9 @@ struct task_struct {
...
@@ -1392,10 +1403,15 @@ struct task_struct {
 /* signal handlers */
...
+#endif
 	...
 	size_t sas_ss_size;
@@ -1435,6 +1451,9 @@ struct task_struct {
...
@@ -1561,6 +1580,12 @@ struct task_struct {
 	unsigned long trace;
...
@@ -1573,10 +1598,32 @@ struct task_struct {
...
@@ -1746,6 +1793,15 @@ extern struct pid *cad_pid;
...
+#else
 ...
 static inline void put_task_struct(struct task_struct *t)
@@ -1753,6 +1809,7 @@ static inline void put_task_struct(struct task_struct *t)
 	if (atomic_dec_and_test(&t->usage))
 		__put_task_struct(t);
 }
+#endif
...
@@ -1777,6 +1834,7 @@ extern void thread_group_times(struct task_struct *p, cputime_t *ut, cputime_t *
...
@@ -1859,6 +1917,10 @@ extern void do_set_cpus_allowed(struct task_struct *p,
...
+
 ...
 static inline void do_set_cpus_allowed(struct task_struct *p,
 				      const struct cpumask *new_mask)
@@ -1871,6 +1933,9 @@ static inline int set_cpus_allowed_ptr(struct task_struct *p,
 		return -EINVAL;
 	return 0;
 }
...
@@ -2024,15 +2089,32 @@ static inline void sched_autogroup_exit(struct signal_struct *sig) { }
 #endif
...
@@ -2112,6 +2194,7 @@ extern void xtime_update(unsigned long ticks);
...
@@ -2201,12 +2284,24 @@ extern struct mm_struct * mm_alloc(void);
...
@@ -2512,7 +2607,7 @@ extern int _cond_resched(void);
...
@@ -2523,12 +2618,16 @@ extern int __cond_resched_lock(spinlock_t *lock);
...
@@ -2552,7 +2651,7 @@ void thread_group_cputimer(struct task_struct *tsk, struct task_cputime *times);
...
+	raw_spin_lock_init(&sig->cputimer.lock);
 ...
 /*
@@ -2600,6 +2699,26 @@ static inline void set_task_cpu(struct task_struct *p, unsigned int cpu)
...
+#include <linux/posix-timers.h>
 ...
 #include <asm/io.h>
@@ -368,9 +369,7 @@ static noinline void __init_refok rest_init(void)
...
+	schedule_preempt_disabled();
 	...
 	cpu_idle();
@@ -492,6 +491,7 @@ asmlinkage void __init start_kernel(void)
...
@@ -876,29 +876,29 @@ static void cgroup_clear_directory(struct dentry *dentry)
 	struct list_head *node;
...
+	seq_spin_unlock(&dentry->d_lock);
 ...
 /*
@@ -911,11 +911,11 @@ static void cgroup_d_remove_dir(struct dentry *dentry)
...
@@ -4678,13 +4678,13 @@ static void check_for_release(struct cgroup *cgrp)
...
@@ -4736,7 +4736,7 @@ static void cgroup_release_agent(struct work_struct *work)
 {
...
+	raw_spin_lock(&release_list_lock);
 	while (!list_empty(&release_list)) {
 		char *argv[3], *envp[3];
 		int i;
@@ -4745,7 +4745,7 @@ static void cgroup_release_agent(struct work_struct *work)
 						    struct cgroup,
 						    release_list);
 		list_del_init(&cgrp->release_list);
-		spin_unlock(&release_list_lock);
+		raw_spin_unlock(&release_list_lock);
 		...
 		if (!pathbuf)
 			goto continue_free;
@@ -4775,9 +4775,9 @@ static void cgroup_release_agent(struct work_struct *work)
  continue_free:
 		kfree(pathbuf);
 		kfree(agentbuf);
-		spin_lock(&release_list_lock);
...
+
 ...
 {
 	might_sleep();
@@ -211,13 +489,15 @@ static int __ref take_cpu_down(void *_param)
...
+	cpumask_var_t cpumask_org;
 	...
 	if (num_online_cpus() == 1)
 		return -EBUSY;
@@ -225,7 +505,33 @@ static int __ref _cpu_down(unsigned int cpu, int tasks_frozen)
 	if (!cpu_online(cpu))
 		return -EINVAL;
...
+	}
 	...
 	if (err) {
@@ -236,6 +542,11 @@ static int __ref _cpu_down(unsigned int cpu, int tasks_frozen)
 		goto out_release;
 	}
...
@@ -264,9 +575,15 @@ static int __ref _cpu_down(unsigned int cpu, int tasks_frozen)
 	check_for_tasks(cpu);
...
index acdc087..ac3af83 100644
--- a/kernel/events/core.c
+++ b/kernel/events/core.c
@@ -3962,9 +3962,15 @@ static bool perf_output_space(struct perf_buffer *buffer, unsigned long tail,
...
@@ -5742,6 +5748,7 @@ static void perf_swevent_init_hrtimer(struct perf_event *event)
...
index 3d42aa3..086388f 100644
--- a/kernel/fork.c
+++ b/kernel/fork.c
@@ -89,7 +89,7 @@ int max_threads;		/* tunable limit on nr_threads */
...
@@ -200,7 +200,18 @@ void __put_task_struct(struct task_struct *tsk)
...
@@ -548,6 +559,19 @@ void __mmdrop(struct mm_struct *mm)
 }
...
+
  ...
  */
@@ -833,13 +857,13 @@ static int copy_fs(unsigned long clone_flags, struct task_struct *tsk)
 	struct fs_struct *fs = current->fs;
...
@@ -1037,6 +1061,9 @@ void mm_init_owner(struct mm_struct *mm, struct task_struct *p)
  */
...
@@ -1144,6 +1171,7 @@ static struct task_struct *copy_process(unsigned long clone_flags,
...
@@ -1201,6 +1229,9 @@ static struct task_struct *copy_process(unsigned long clone_flags,
 	p->hardirq_context = 0;
 	p->softirq_context = 0;
 #endif
+#ifdef CONFIG_PREEMPT_RT_FULL
...
+#endif
 	...
 	p->curr_chain_key = 0;
@@ -1704,13 +1735,13 @@ SYSCALL_DEFINE1(unshare, unsigned long, unshare_flags)
...
+	struct futex_hash_bucket *hb, *hb2;
 	...
 	int res, ret;
@@ -2312,8 +2322,7 @@ static int futex_wait_requeue_pi(u32 __user *uaddr, unsigned int flags,
...
+	rt_mutex_init_waiter(&rt_waiter, false);
 	...
 	if (unlikely(ret != 0))
@@ -2334,20 +2343,55 @@ static int futex_wait_requeue_pi(u32 __user *uaddr, unsigned int flags,
...
+	hb2 = hash_futex(&key2);
 	...
 	if (!q.rt_waiter) {
@@ -2356,9 +2400,10 @@ static int futex_wait_requeue_pi(u32 __user *uaddr, unsigned int flags,
...
+			spin_unlock(&hb2->lock);
 		...
 		/*
@@ -2371,7 +2416,8 @@ static int futex_wait_requeue_pi(u32 __user *uaddr, unsigned int flags,
...
+#include <trace/events/hist.h>
 ...
 /*
  * The timer bases:
@@ -593,8 +594,7 @@ static int hrtimer_reprogram(struct hrtimer *timer,
...
+	 * reprogramming is handled at the end of the hrtimer_interrupt.
 	...
 	if (hrtimer_callback_running(timer))
 		return 0;
@@ -629,6 +629,9 @@ static int hrtimer_reprogram(struct hrtimer *timer,
 	return res;
 }
...
+
  ...
  */
@@ -737,6 +740,11 @@ static inline int hrtimer_enqueue_reprogram(struct hrtimer *timer,
 }
...
@@ -853,6 +861,32 @@ u64 hrtimer_forward(struct hrtimer *timer, ktime_t now, ktime_t interval)
 }
...
+
  ...
  *
@@ -896,6 +930,11 @@ static void __remove_hrtimer(struct hrtimer *timer,
...
@@ -980,6 +1019,17 @@ int __hrtimer_start_range_ns(struct hrtimer *timer, ktime_t tim,
 #endif
 	}
...
@@ -994,7 +1044,17 @@ int __hrtimer_start_range_ns(struct hrtimer *timer, ktime_t tim,
 	 */
...
@@ -1003,9 +1063,18 @@ int __hrtimer_start_range_ns(struct hrtimer *timer, ktime_t tim,
...
@@ -1092,7 +1161,7 @@ int hrtimer_cancel(struct hrtimer *timer)
...
@@ -1171,6 +1240,7 @@ static void __hrtimer_init(struct hrtimer *timer, clockid_t clock_id,
...
+	INIT_LIST_HEAD(&timer->cb_entry);
 ...
 #ifdef CONFIG_TIMER_STATS
@@ -1254,6 +1324,122 @@ static void __run_hrtimer(struct hrtimer *timer, ktime_t *now)
 	timer->state &= ~HRTIMER_STATE_CALLBACK;
 }
...
+
 ...
 /*
@@ -1264,7 +1450,7 @@ void hrtimer_interrupt(struct clock_event_device *dev)
 {
...
+		raise_softirq_irqoff(HRTIMER_SOFTIRQ);
 ...
 /*
@@ -1419,17 +1620,17 @@ void hrtimer_peek_ahead_timers(void)
 	local_irq_restore(flags);
 }
...
+
  ...
  *
@@ -1462,7 +1663,7 @@ void hrtimer_run_queues(void)
...
+	int index, gettime = 1, raise = 0;
 	...
 	if (hrtimer_hres_active())
 		return;
@@ -1487,10 +1688,16 @@ void hrtimer_run_queues(void)
...
+		raise_softirq_irqoff(HRTIMER_SOFTIRQ);
 ...
 /*
@@ -1512,6 +1719,7 @@ static enum hrtimer_restart hrtimer_wakeup(struct hrtimer *timer)
...
@@ -1648,9 +1856,13 @@ static void __cpuinit init_hrtimers_cpu(int cpu)
...
+#endif
 ...
 #ifdef CONFIG_HOTPLUG_CPU
@@ -1763,9 +1975,7 @@ void __init hrtimers_init(void)
...
@@ -746,7 +821,15 @@ irq_forced_thread_fn(struct irq_desc *desc, struct irqaction *action)
 	local_bh_disable();
...
@@ -770,9 +853,6 @@ static irqreturn_t irq_thread_fn(struct irq_desc *desc,
  */
...
@@ -785,7 +865,6 @@ static int irq_thread(void *data)
 	else
...
@@ -922,11 +1001,17 @@ __setup_irq(unsigned int irq, struct irq_desc *desc, struct irqaction *new)
 	 */
...
@@ -1064,6 +1149,9 @@ __setup_irq(unsigned int irq, struct irq_desc *desc, struct irqaction *new)
...
+	raw_spin_unlock_irqrestore(hlist_lock, *flags);
 ...
 /*
@@ -1650,20 +1650,20 @@ static int __kprobes pre_handler_kretprobe(struct kprobe *p,
...
@@ -1676,7 +1676,7 @@ static int __kprobes pre_handler_kretprobe(struct kprobe *p,
...
@@ -1712,7 +1712,7 @@ int __kprobes register_kretprobe(struct kretprobe *rp)
...
@@ -1950,7 +1950,7 @@ static int __init init_kprobes(void)
...
index 8e48cf6..9380d16 100644
--- a/kernel/panic.c
+++ b/kernel/panic.c
@@ -338,9 +338,11 @@ static u64 oops_id;
...
+	system_state = SYSTEM_RUNNING;
  ...
  Enable_cpus:
@@ -414,6 +417,7 @@ static int resume_target_kernel(bool platform_mode)
 		goto Enable_cpus;
...
+	system_state = SYSTEM_SUSPEND;
 	...
 	error = syscore_suspend();
 	if (error)
@@ -447,6 +451,7 @@ static int resume_target_kernel(bool platform_mode)
 	syscore_resume();
...
+	system_state = SYSTEM_RUNNING;
  ...
  Enable_cpus:
@@ -529,6 +534,7 @@ int hibernation_platform_enter(void)
...
+	system_state = SYSTEM_SUSPEND;
 	...
 	if (pm_wakeup_pending()) {
 		error = -EAGAIN;
@@ -541,6 +547,7 @@ int hibernation_platform_enter(void)
...
index e40d205..a217d28 100644
--- a/kernel/power/suspend.c
+++ b/kernel/power/suspend.c
@@ -164,6 +164,8 @@ static int suspend_enter(suspend_state_t state)
...
@@ -173,6 +175,8 @@ static int suspend_enter(suspend_state_t state)
 		syscore_resume();
 	}
...
@@ -100,7 +93,7 @@ static int console_locked, console_suspended;
...
@@ -365,18 +358,18 @@ int do_syslog(int type, char __user *buf, int len, bool from_file)
 		if (error)
 			goto out;
 		i = 0;
...
+		raw_spin_unlock_irq(&logbuf_lock);
 		if (!error)
 			error = i;
 		break;
@@ -399,7 +392,7 @@ int do_syslog(int type, char __user *buf, int len, bool from_file)
 		count = len;
...
+		raw_spin_lock_irq(&logbuf_lock);
 		if (count > logged_chars)
 			count = logged_chars;
 		if (do_clear)
@@ -416,12 +409,12 @@ int do_syslog(int type, char __user *buf, int len, bool from_file)
...
+	migrate_disable();
 	for_each_console(con) {
 		if (exclusive_console && con != exclusive_console)
 			continue;
@@ -519,8 +513,62 @@ static void __call_console_drivers(unsigned start, unsigned end)
...
@@ -700,7 +748,7 @@ static void zap_locks(void)
...
+	if (lock && console_trylock()) {
 		...
 		/*
@@ -813,7 +867,7 @@ static int console_trylock_for_printk(unsigned int cpu)
 		}
 	}
 	printk_cpu = UINT_MAX;
...
@@ -846,10 +900,17 @@ asmlinkage int vprintk(const char *fmt, va_list args)
 	size_t plen;
 	char special;
...
@@ -873,7 +934,7 @@ asmlinkage int vprintk(const char *fmt, va_list args)
 	}
...
+	raw_spin_lock(&logbuf_lock);
 	...
 	if (recursion_bug) {
@@ -966,14 +1027,21 @@ asmlinkage int vprintk(const char *fmt, va_list args)
...
@@ -1226,8 +1294,8 @@ void printk_tick(void)
...
@@ -1265,18 +1333,23 @@ void console_unlock(void)
...
@@ -1285,7 +1358,7 @@ void console_unlock(void)
...
@@ -1515,9 +1588,9 @@ void register_console(struct console *newcon)
...
@@ -1724,10 +1797,10 @@ void kmsg_dump(enum kmsg_dump_reason reason)
...
@@ -1155,7 +1164,7 @@ static void __rcu_offline_cpu(int cpu, struct rcu_state *rsp)
 	else
...
@@ -1581,6 +1590,7 @@ void call_rcu_sched(struct rcu_head *head, void (*func)(struct rcu_head *rcu))
 }
...
+#ifndef CONFIG_PREEMPT_RT_FULL
  ...
  */
@@ -1589,6 +1599,7 @@ void call_rcu_bh(struct rcu_head *head, void (*func)(struct rcu_head *rcu))
...
@@ -1630,6 +1641,7 @@ void synchronize_sched(void)
 }
...
+#ifndef CONFIG_PREEMPT_RT_FULL
  ...
  *
@@ -1655,6 +1667,7 @@ void synchronize_rcu_bh(void)
...
@@ -1808,6 +1821,7 @@ static void _rcu_barrier(struct rcu_state *rsp,
...
+#ifndef CONFIG_PREEMPT_RT_FULL
  ...
  */
@@ -1816,6 +1830,7 @@ void rcu_barrier_bh(void)
...
@@ -797,7 +799,11 @@ late_initcall(sched_init_debug);
...
@@ -1133,6 +1139,7 @@ static void init_rq_hrtick(struct rq *rq)
...
@@ -2274,7 +2281,8 @@ unsigned long wait_task_inactive(struct task_struct *p, long match_state)
...
@@ -2289,7 +2297,8 @@ unsigned long wait_task_inactive(struct task_struct *p, long match_state)
...
@@ -2375,11 +2384,11 @@ static int select_fallback_rq(int cpu, struct task_struct *p)
...
@@ -2394,7 +2403,12 @@ static int select_fallback_rq(int cpu, struct task_struct *p)
...
@@ -2416,7 +2430,7 @@ int select_task_rq(struct task_struct *p, int sd_flags, int wake_flags)
...
@@ -2474,10 +2488,6 @@ static void ttwu_activate(struct rq *rq, struct task_struct *p, int en_flags)
 {
...
-		wq_worker_waking_up(p, cpu_of(rq));
 ...
 /*
@@ -2675,8 +2685,27 @@ try_to_wake_up(struct task_struct *p, unsigned int state, int wake_flags)
...
@@ -4113,8 +4122,13 @@ void __kprobes add_preempt_count(int val)
...
@@ -4156,6 +4170,13 @@ static noinline void __schedule_bug(struct task_struct *prev)
 	print_modules();
 	if (irqs_disabled())
...
+#endif
 	...
 	if (regs)
 		show_regs(regs);
@@ -4181,6 +4202,126 @@ static inline void schedule_debug(struct task_struct *prev)
...
@@ -4310,15 +4450,37 @@ static inline void sched_submit_work(struct task_struct *tsk)
...
@@ -4390,7 +4552,16 @@ asmlinkage void __sched notrace preempt_schedule(void)
...
+		stop_critical_timings();
 		...
 		/*
@@ -4486,9 +4657,9 @@ EXPORT_SYMBOL(__wake_up);
 /*
...
@@ -4813,18 +4984,18 @@ long __sched sleep_on_timeout(wait_queue_head_t *q, long timeout)
...
+void task_setprio(struct task_struct *p, int prio)
 {
 	...
 	struct rq *rq;
@@ -4834,6 +5005,24 @@ void rt_mutex_setprio(struct task_struct *p, int prio)
...
@@ -4857,9 +5046,9 @@ void rt_mutex_setprio(struct task_struct *p, int prio)
...
@@ -4994,7 +5183,13 @@ EXPORT_SYMBOL(task_nice);
  */
...
+#endif
 ...
 /**
@@ -5015,20 +5210,25 @@ static struct task_struct *find_process_by_pid(pid_t pid)
...
-	set_load_weight(p);
 ...
 /*
@@ -5053,6 +5253,7 @@ static bool check_same_owner(struct task_struct *p)
...
+	}
 	...
 	check_class_changed(rq, p, prev_class, oldprio);
 	task_rq_unlock(rq, p, &flags);
@@ -5528,7 +5752,7 @@ SYSCALL_DEFINE0(sched_yield)
 	__release(rq->lock);
...
@@ -5542,9 +5766,17 @@ static inline int should_resched(void)
...
@@ -5585,6 +5817,7 @@ int __cond_resched_lock(spinlock_t *lock)
 }
...
+#ifndef CONFIG_PREEMPT_RT_FULL
 ...
 {
 	BUG_ON(!in_softirq());
@@ -5598,6 +5831,7 @@ int __sched __cond_resched_softirq(void)
 	return 0;
 }
...
@@ -5844,7 +6078,7 @@ void show_state_filter(unsigned long state_filter)
 	printk(KERN_INFO
...
@@ -5860,7 +6094,7 @@ void show_state_filter(unsigned long state_filter)
 #ifdef CONFIG_SCHED_DEBUG
...
+	rcu_read_unlock();
 	 ...
 	 */
@@ -5908,6 +6142,7 @@ void __cpuinit init_idle(struct task_struct *idle, int cpu)
 	rcu_read_unlock();
...
+	idle->on_rq = 1;
 	...
 	idle->on_cpu = 1;
 #endif
@@ -5921,6 +6156,9 @@ void __cpuinit init_idle(struct task_struct *idle, int cpu)
 	 */
...
+#endif
 ...
 /*
@@ -5982,12 +6220,90 @@ static inline void sched_init_granularity(void)
 #ifdef CONFIG_SMP
...
+	return 1;
 ...
 /*
@@ -6038,7 +6354,7 @@ int set_cpus_allowed_ptr(struct task_struct *p, const struct cpumask *new_mask)
...
@@ -6085,7 +6401,7 @@ static int __migrate_task(struct task_struct *p, int src_cpu, int dest_cpu)
...
+	if (!cpumask_test_cpu(dest_cpu, tsk_cpus_allowed(p)))
 	...
 	/*
@@ -6127,6 +6443,8 @@ static int migration_cpu_stop(void *data)
...
+
  ...
  * offline.
@@ -6139,7 +6457,12 @@ void idle_task_exit(void)
...
+	per_cpu(idle_last_mm, smp_processor_id()) = mm;
 ...
 /*
@@ -6457,6 +6780,12 @@ migration_call(struct notifier_block *nfb, unsigned long action, void *hcpu)
...
@@ -8203,7 +8532,8 @@ void __init sched_init(void)
...
@@ -8231,6 +8561,13 @@ void __might_sleep(const char *file, int line, int preempt_offset)
...
@@ -1619,9 +1642,6 @@ static void set_cpus_allowed_rt(struct task_struct *p,
...
@@ -512,7 +584,7 @@ static void collect_signal(int sig, struct sigpending *list, siginfo_t *info)
 still_pending:
...
@@ -558,6 +630,8 @@ int dequeue_signal(struct task_struct *tsk, sigset_t *mask, siginfo_t *info)
 {
 	int signr;
...
+
 	 ...
 	 * signalfd steal them
 	 */
@@ -637,6 +711,10 @@ int dequeue_signal(struct task_struct *tsk, sigset_t *mask, siginfo_t *info)
...
@@ -1120,8 +1198,8 @@ int do_send_sig_info(int sig, struct siginfo *info, struct task_struct *p,
...
@@ -1146,6 +1224,39 @@ force_sig_info(int sig, struct siginfo *info, struct task_struct *t)
 	return ret;
 }
...
+
  ...
  */
@@ -1176,12 +1287,12 @@ struct sighand_struct *__lock_task_sighand(struct task_struct *tsk,
 	struct sighand_struct *sighand;
...
@@ -1192,7 +1303,7 @@ struct sighand_struct *__lock_task_sighand(struct task_struct *tsk,
 		}
 		spin_unlock(&sighand->siglock);
 		rcu_read_unlock();
-		local_irq_restore(*flags);
+		local_irq_restore_nort(*flags);
 	...
 	return sighand;
@@ -1431,7 +1542,8 @@ EXPORT_SYMBOL(kill_pid);
  */
...
@@ -1783,15 +1895,7 @@ static void ptrace_stop(int exit_code, int why, int clear_code, siginfo_t *info)
...
+#include <linux/kthread.h>
 ...
 #include <linux/time.h>
@@ -406,7 +407,6 @@ int second_overflow(unsigned long secs)
 		break;
 	}
...
@@ -495,11 +495,52 @@ static void sync_cmos_clock(struct work_struct *work)
...
@@ -627,7 +668,8 @@ int do_adjtimex(struct timex *txc)
...
@@ -669,7 +711,8 @@ int do_adjtimex(struct timex *txc)
...
@@ -867,7 +910,8 @@ void hardpps(const struct timespec *phase_ts, const struct timespec *raw_ts)
...
@@ -880,7 +924,8 @@ void hardpps(const struct timespec *phase_ts, const struct timespec *raw_ts)
...
@@ -895,7 +940,8 @@ void hardpps(const struct timespec *phase_ts, const struct timespec *raw_ts)
...
@@ -912,7 +958,8 @@ void hardpps(const struct timespec *phase_ts, const struct timespec *raw_ts)
...
@@ -304,24 +308,18 @@ void tick_nohz_stop_sched_tick(int inidle)
 		goto end;
...
+	} while (read_seqcount_retry(&xtime_seq, seq));
 	...
 	if (rcu_needs_cpu(cpu) || printk_needs_cpu(cpu) ||
 	    arch_needs_cpu(cpu)) {
@@ -777,6 +775,7 @@ void tick_setup_sched_timer(void)
...
@@ -738,10 +748,12 @@ static int timekeeping_suspend(void)
...
+	raw_spin_unlock_irqrestore(&xtime_lock, flags);
 	...
 	clocksource_suspend();
@@ -1044,13 +1056,13 @@ void get_monotonic_boottime(struct timespec *ts)
 	WARN_ON(timekeeping_suspended);
...
@@ -1101,10 +1113,10 @@ struct timespec current_kernel_time(void)
 	unsigned long seq;
...
@@ -1116,11 +1128,11 @@ struct timespec get_monotonic_coarse(void)
 	unsigned long seq;
...
@@ -1152,11 +1164,11 @@ void get_xtime_and_monotonic_and_sleep_offset(struct timespec *xtim,
 	unsigned long seq;
...
+	} while (read_seqcount_retry(&xtime_seq, seq));
 ...
 #ifdef CONFIG_HIGH_RES_TIMERS
@@ -1175,7 +1187,7 @@ ktime_t ktime_get_update_offsets(ktime_t *real, ktime_t *boot)
 	u64 secs, nsecs;
...
+		seq = read_seqcount_begin(&xtime_seq);
 		...
 		secs = xtime.tv_sec;
 		nsecs = xtime.tv_nsec;
@@ -1185,7 +1197,7 @@ ktime_t ktime_get_update_offsets(ktime_t *real, ktime_t *boot)
...
@@ -1202,9 +1214,9 @@ ktime_t ktime_get_monotonic_offset(void)
...
@@ -1216,7 +1228,9 @@ ktime_t ktime_get_monotonic_offset(void)
  */
...
@@ -3212,21 +3255,6 @@ rb_iter_peek(struct ring_buffer_iter *iter, u64 *ts)
 }
...
@@ -3244,22 +3272,17 @@ ring_buffer_peek(struct ring_buffer *buffer, int cpu, u64 *ts,
...
+	read_buffer_unlock(cpu_buffer, flags, locked);
 	...
 	if (event && event->type_len == RINGBUF_TYPE_PADDING)
 		goto again;
@@ -3281,11 +3304,12 @@ ring_buffer_iter_peek(struct ring_buffer_iter *iter, u64 *ts)
...
+	read_buffer_unlock(cpu_buffer, flags, locked);
 	...
 	if (event && event->type_len == RINGBUF_TYPE_PADDING)
 		goto again;
@@ -3311,9 +3335,7 @@ ring_buffer_consume(struct ring_buffer *buffer, int cpu, u64 *ts,
 	struct ring_buffer_per_cpu *cpu_buffer;
...
@@ -3323,9 +3345,7 @@ ring_buffer_consume(struct ring_buffer *buffer, int cpu, u64 *ts,
 		goto out;
...
+	locked = read_buffer_lock(cpu_buffer, &flags);
 	...
 	event = rb_buffer_peek(cpu_buffer, ts, lost_events);
 	if (event) {
@@ -3333,9 +3353,8 @@ ring_buffer_consume(struct ring_buffer *buffer, int cpu, u64 *ts,
 		rb_advance_reader(cpu_buffer);
 	}
...
+
  ...
  out:
 	preempt_enable();
@@ -3420,17 +3439,18 @@ ring_buffer_read_start(struct ring_buffer_iter *iter)
 {
 	struct ring_buffer_per_cpu *cpu_buffer;
 	unsigned long flags;
+	int locked;
...
@@ -3464,8 +3484,9 @@ ring_buffer_read(struct ring_buffer_iter *iter, u64 *ts)
 	struct ring_buffer_event *event;
 	struct ring_buffer_per_cpu *cpu_buffer = iter->cpu_buffer;
 	unsigned long flags;
+	int locked;
...
+	locked = read_buffer_lock(cpu_buffer, &flags);
  again:
 	event = rb_iter_peek(iter, ts);
 	if (!event)
@@ -3476,7 +3497,7 @@ ring_buffer_read(struct ring_buffer_iter *iter, u64 *ts)
...
@@ -3539,13 +3560,14 @@ void ring_buffer_reset_cpu(struct ring_buffer *buffer, int cpu)
 {
 	struct ring_buffer_per_cpu *cpu_buffer = buffer->buffers[cpu];
 	unsigned long flags;
+	int locked;
...
+	locked = read_buffer_lock(cpu_buffer, &flags);
 	...
 	if (RB_WARN_ON(cpu_buffer, local_read(&cpu_buffer->committing)))
 		goto out;
@@ -3557,7 +3579,7 @@ void ring_buffer_reset_cpu(struct ring_buffer *buffer, int cpu)
 	arch_spin_unlock(&cpu_buffer->lock);
...
@@ -3584,22 +3606,16 @@ int ring_buffer_empty(struct ring_buffer *buffer)
 {
 	struct ring_buffer_per_cpu *cpu_buffer;
 	unsigned long flags;
-	int dolock;
...
+		read_buffer_unlock(cpu_buffer, flags, locked);
 		...
 		if (!ret)
 			return 0;
@@ -3618,22 +3634,16 @@ int ring_buffer_empty_cpu(struct ring_buffer *buffer, int cpu)
 {
 	struct ring_buffer_per_cpu *cpu_buffer;
 	unsigned long flags;
-	int dolock;
...
@@ -3807,6 +3817,7 @@ int ring_buffer_read_page(struct ring_buffer *buffer,
 	unsigned int commit;
 	unsigned int read;
 	u64 save_timestamp;
+	int locked;
 	...
 	if (!cpumask_test_cpu(cpu, buffer->cpumask))
@@ -3828,7 +3839,7 @@ int ring_buffer_read_page(struct ring_buffer *buffer,
 	if (!bpage)
 		goto out;
...
+	locked = read_buffer_lock(cpu_buffer, &flags);
 	...
 	if (!reader)
@@ -3951,7 +3962,7 @@ int ring_buffer_read_page(struct ring_buffer *buffer,
...
@@ -725,6 +727,12 @@ update_max_tr_single(struct trace_array *tr, struct task_struct *tsk, int cpu)
 }
...
@@ -967,7 +975,7 @@ void tracing_start(void)
 	if (tracing_disabled)
 		return;
...
@@ -992,7 +1000,7 @@ void tracing_start(void)
...
+	raw_spin_unlock_irqrestore(&tracing_start_lock, flags);
 ...
 /**
@@ -1007,7 +1015,7 @@ void tracing_stop(void)
 	unsigned long flags;
...
@@ -1025,7 +1033,7 @@ void tracing_stop(void)
...
@@ -1129,6 +1137,8 @@ tracing_generic_entry_update(struct trace_entry *entry, unsigned long flags,
...
@@ -1766,9 +1776,10 @@ static void print_lat_help_header(struct seq_file *m)
...
@@ -3100,6 +3111,7 @@ static int tracing_release_pipe(struct inode *inode, struct file *file)
 	return 0;
 }
...
+#ifndef CONFIG_PREEMPT_RT_FULL
 ...
 {
@@ -3121,8 +3133,7 @@ tracing_poll_pipe(struct file *filp, poll_table *poll_table)
 	}
 }
...
@@ -3133,6 +3144,20 @@ void default_wait_pipe(struct trace_iterator *iter)
...
index 123ee28..d07ae7a 100644
--- a/kernel/trace/trace.h
+++ b/kernel/trace/trace.h
@@ -326,7 +326,6 @@ void trace_init_global_iter(struct trace_iterator *iter);
...
+	int			sleeping;	/* None */
 ...
 /*
@@ -659,66 +660,58 @@ static void wake_up_worker(struct global_cwq *gcwq)
 }
...
+	spin_unlock_irq(&gcwq->lock);
 ...
 /**
@@ -1069,8 +1062,8 @@ int queue_work(struct workqueue_struct *wq, struct work_struct *work)
 {
 	int ret;
...
@@ -1214,13 +1207,8 @@ static void worker_enter_idle(struct worker *worker)
 	} else
...
@@ -3503,6 +3491,25 @@ static int __devinit workqueue_cpu_callback(struct notifier_block *nfb,
...
@@ -3522,16 +3529,6 @@ static int __devinit workqueue_cpu_callback(struct notifier_block *nfb,
...
-
 	case CPU_POST_DEAD:
 		...
 		/* fall through */
@@ -3565,6 +3562,7 @@ static int __devinit workqueue_cpu_callback(struct notifier_block *nfb,
...
index 10481eb..09d5e27 100644
--- a/mm/filemap.c
+++ b/mm/filemap.c
@@ -2026,7 +2026,7 @@ size_t iov_iter_copy_from_user_atomic(struct page *page,
 	char *kaddr;
 	size_t copied;
...
index ac8d3a1..1ccc5fe 100644
--- a/mm/memory.c
+++ b/mm/memory.c
@@ -1303,13 +1303,6 @@ static unsigned long unmap_page_range(struct mmu_gather *tlb,
 	return addr;
 }
...
+
  ...
  */
@@ -4055,3 +4074,35 @@ void copy_user_huge_page(struct page *dst, struct page *src,
 	}
 }
...
@@ -1918,8 +1977,8 @@ __alloc_pages_direct_compact(gfp_t gfp_mask, unsigned int order,
...
@@ -3737,14 +3796,16 @@ static int __zone_pcp_update(void *data)
 	for_each_possible_cpu(cpu) {
 		struct per_cpu_pageset *pset;
 		struct per_cpu_pages *pcp;
+		LIST_HEAD(dst);
...
@@ -5059,6 +5120,7 @@ static int page_alloc_cpu_notify(struct notifier_block *self,
...
+
 ...
 /*
@@ -620,70 +628,171 @@ int slab_is_available(void)
...
+
 static inline struct kmem_cache *__find_general_cachep(size_t size,
 							gfp_t gfpflags)
 {
@@ -1021,9 +1130,10 @@ static void reap_alien(struct kmem_cache *cachep, struct kmem_list3 *l3)
 	if (l3->alien) {
...
@@ -1038,9 +1148,9 @@ static void drain_alien_cache(struct kmem_cache *cachep,
...
@@ -1119,11 +1229,11 @@ static int init_cache_nodelists_node(int node)
...
@@ -1148,7 +1258,7 @@ static void __cpuinit cpuup_canceled(long cpu)
 		if (!l3)
...
@@ -1156,7 +1266,7 @@ static void __cpuinit cpuup_canceled(long cpu)
...
@@ -1170,7 +1280,7 @@ static void __cpuinit cpuup_canceled(long cpu)
 		alien = l3->alien;
 		l3->alien = NULL;
...
+		unlock_l3_and_free_delayed(&l3->list_lock);
 		...
 		kfree(shared);
 		if (alien) {
@@ -1244,7 +1354,7 @@ static int __cpuinit cpuup_prepare(long cpu)
 		l3 = cachep->nodelists[node];
 		BUG_ON(!l3);
...
@@ -1259,9 +1369,11 @@ static int __cpuinit cpuup_prepare(long cpu)
 			alien = NULL;
 		}
 #endif
-		spin_unlock_irq(&l3->list_lock);
...
@@ -1448,6 +1560,10 @@ void __init kmem_cache_init(void)
...
+
 	for (i = 0; i < NUM_INIT_LISTS; i++) {
 		...
 		if (i < MAX_NUMNODES)
@@ -1625,19 +1741,20 @@ void __init kmem_cache_init_late(void)
 {
 	struct kmem_cache *cachep;
...
@@ -1725,12 +1842,14 @@ static void *kmem_getpages(struct kmem_cache *cachep, gfp_t flags, int nodeid)
 /*
...
@@ -1746,7 +1865,13 @@ static void kmem_freepages(struct kmem_cache *cachep, void *addr)
 	}
...
@@ -1754,7 +1879,7 @@ static void kmem_rcu_free(struct rcu_head *head)
...
@@ -1973,7 +2098,8 @@ static void slab_destroy_debugcheck(struct kmem_cache *cachep, struct slab *slab
...
@@ -1986,7 +2112,7 @@ static void slab_destroy(struct kmem_cache *cachep, struct slab *slabp)
 		slab_rcu->addr = addr;
...
@@ -2424,6 +2550,18 @@ kmem_cache_create (const char *name, size_t size, size_t align,
 		goto oops;
 	}
...
+
 ...
 oops:
@@ -2441,7 +2579,7 @@ EXPORT_SYMBOL(kmem_cache_create);
 #if DEBUG
...
@@ -2476,26 +2614,43 @@ static void drain_array(struct kmem_cache *cachep, struct kmem_list3 *l3,
...
+	slab_on_each_cpu(do_drain, cachep);
 	...
 	for_each_online_node(node) {
 		l3 = cachep->nodelists[node];
@@ -2526,10 +2681,10 @@ static int drain_freelist(struct kmem_cache *cache,
 	nr_freed = 0;
...
@@ -2543,8 +2698,8 @@ static int drain_freelist(struct kmem_cache *cache,
 		 * to the cache.
 		 */
...
+		slab_destroy(cache, slabp, false);
 ...
 out:
@@ -2838,7 +2993,7 @@ static int cache_grow(struct kmem_cache *cachep,
...
@@ -2868,7 +3023,7 @@ static int cache_grow(struct kmem_cache *cachep,
...
@@ -2879,10 +3034,10 @@ static int cache_grow(struct kmem_cache *cachep,
...
@@ -3403,7 +3558,7 @@ __cache_alloc_node(struct kmem_cache *cachep, gfp_t flags, int nodeid,
 		return NULL;
...
+	local_lock_irqsave(slab_lock, save_flags);
 	...
 	if (nodeid == -1)
 		nodeid = slab_node;
@@ -3428,7 +3583,7 @@ __cache_alloc_node(struct kmem_cache *cachep, gfp_t flags, int nodeid,
...
+	local_unlock_irqrestore(slab_lock, save_flags);
 	...
 	kmemleak_alloc_recursive(ptr, obj_size(cachep), 1, cachep->flags,
 				 flags);
@@ -3488,9 +3643,9 @@ __cache_alloc(struct kmem_cache *cachep, gfp_t flags, void *caller)
 		return NULL;
...
+	local_unlock_irqrestore(slab_lock, save_flags);
 	...
 	kmemleak_alloc_recursive(objp, obj_size(cachep), 1, cachep->flags,
 				 flags);
@@ -3538,7 +3693,7 @@ static void free_block(struct kmem_cache *cachep, void **objpp, int nr_objects,
...
@@ -3801,12 +3956,12 @@ void kmem_cache_free(struct kmem_cache *cachep, void *objp)
 {
 	unsigned long flags;
...
@@ -3830,13 +3985,13 @@ void kfree(const void *objp)
...
@@ -3879,7 +4034,7 @@ static int alloc_kmemlist(struct kmem_cache *cachep, gfp_t gfp)
 		if (l3) {
...
@@ -3892,7 +4047,8 @@ static int alloc_kmemlist(struct kmem_cache *cachep, gfp_t gfp)
 			}
...
+
 			...
 			continue;
@@ -3939,18 +4095,31 @@ struct ccupdate_struct {
...
@@ -3974,7 +4143,7 @@ static int do_tune_cpucache(struct kmem_cache *cachep, int limit,
 	}
 	new->cachep = cachep;
...
@@ -3985,9 +4154,11 @@ static int do_tune_cpucache(struct kmem_cache *cachep, int limit,
...
+		unlock_l3_and_free_delayed(&cachep->nodelists[cpu_to_mem(i)]->list_lock);
 	...
 	kfree(new);
@@ -4063,7 +4234,7 @@ static void drain_array(struct kmem_cache *cachep, struct kmem_list3 *l3,
 	if (ac->touched && !force) {
 		ac->touched = 0;
 	} else {
-		spin_lock_irq(&l3->list_lock);
+		local_spin_lock_irq(slab_lock, &l3->list_lock);
 		if (ac->avail) {
 			...
 			if (tofree > ac->avail)
@@ -4073,7 +4244,7 @@ static void drain_array(struct kmem_cache *cachep, struct kmem_list3 *l3,
...
@@ -4212,7 +4383,7 @@ static int s_show(struct seq_file *m, void *p)
 			continue;
...
@@ -4237,7 +4408,7 @@ static int s_show(struct seq_file *m, void *p)
 		if (l3->shared)
...
@@ -4466,13 +4637,13 @@ static int leaks_show(struct seq_file *m, void *p)
 			continue;
...
@@ -766,6 +772,15 @@ unsigned pagevec_lookup(struct pagevec *pvec, struct address_space *mapping,
...
index 3e9829f3..1aae178 100644
--- a/mm/truncate.c
+++ b/mm/truncate.c
@@ -623,12 +623,12 @@ int vmtruncate_range(struct inode *inode, loff_t offset, loff_t end)
 		return -ENOSYS;
...
index 2174733..78daa3d 100644
--- a/mm/vmscan.c
+++ b/mm/vmscan.c
@@ -1368,8 +1368,8 @@ static int too_many_isolated(struct zone *zone, int file,
  */
...
+		  struct list_head *page_list, unsigned long nr_reclaimed)
 {
 	struct page *page;
 	struct pagevec pvec;
@@ -1380,7 +1380,12 @@ putback_lru_pages(struct zone *zone, struct scan_control *sc,
 	/*
...
@@ -1559,12 +1564,7 @@ shrink_inactive_list(unsigned long nr_to_scan, struct zone *zone,
...
@@ -1734,6 +1734,7 @@ static inline void __netif_reschedule(struct Qdisc *q)
...
@@ -1755,6 +1756,7 @@ void dev_kfree_skb_irq(struct sk_buff *skb)
...
+	preempt_check_resched_rt();
 	...
 	kfree_skb(skb);
@@ -2881,7 +2884,7 @@ int netif_rx(struct sk_buff *skb)
...
@@ -2891,13 +2894,13 @@ int netif_rx(struct sk_buff *skb)
...
+		put_cpu_light();
 ...
 #endif
 	return ret;
@@ -2908,16 +2911,46 @@ int netif_rx_ni(struct sk_buff *skb)
 {
 	int err;
...
@@ -2956,7 +2989,7 @@ static void net_tx_action(struct softirq_action *h)
...
+			if (take_root_lock(root_lock)) {
 				...
 				clear_bit(__QDISC_STATE_SCHED,
 					  &q->state);
@@ -3289,7 +3322,7 @@ static void flush_backlog(void *arg)
...
@@ -3298,10 +3331,13 @@ static void flush_backlog(void *arg)
...
@@ -3640,6 +3676,7 @@ static void net_rps_action_and_irq_enable(struct softnet_data *sd)
 	} else
 #endif
 		local_irq_enable();
+	preempt_check_resched_rt();
...
@@ -3712,6 +3749,7 @@ void __napi_schedule(struct napi_struct *n)
 	local_irq_save(flags);
...
@@ -3786,10 +3824,17 @@ static void net_rx_action(struct softirq_action *h)
 	struct softnet_data *sd = &__get_cpu_var(softnet_data);
...
+
 	while (!list_empty(&sd->poll_list)) {
 		...
 		int work, weight;
@@ -6210,6 +6255,7 @@ static int dev_cpu_callback(struct notifier_block *nfb,
...
@@ -6220,6 +6266,9 @@ static int dev_cpu_callback(struct notifier_block *nfb,
 		netif_rx(skb);
...
@@ -6486,8 +6535,9 @@ static int __init net_dev_init(void)
...
index 3a22b1c..af9d210 100644
--- a/net/ipv4/sysctl_net_ipv4.c
+++ b/net/ipv4/sysctl_net_ipv4.c
@@ -705,6 +705,13 @@ static struct ctl_table ipv4_net_table[] = {
...
index 10e8842..26e7ece 100644
--- a/net/mac80211/rx.c
+++ b/net/mac80211/rx.c
@@ -2873,7 +2873,7 @@ void ieee80211_rx(struct ieee80211_hw *hw, struct sk_buff *skb)
...
index d75eb39..f7c1f1d 100644
--- a/net/netfilter/ipvs/ip_vs_ctl.c
+++ b/net/netfilter/ipvs/ip_vs_ctl.c
@@ -3681,7 +3681,7 @@ int __net_init __ip_vs_control_init(struct net *net)
 	int idx;
